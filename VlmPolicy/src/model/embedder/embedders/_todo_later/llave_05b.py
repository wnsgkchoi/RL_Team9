...
# ───────────────────────────────────────────────────────────────────────────────
LLAVE_PATH                  = "/mnt/sdc/jhyun/models/LLaVE-0.5B"
...
# Main wrapper
# ───────────────────────────────────────────────────────────────────────────────
class LLaVE_05B(BaseEmbedder):
    """MMEmbed-compatible facade around the LLaVE-05B dual-encoder."""
    ...
    def load_model(self) -> None:
        ...
        self.model.eval()
        print("✅  LLaVE-05B loaded on", self.device)
...
if __name__ == "__main__":
    ...
    # 2) init + encode
    encoder = LLaVE_05B(cuda_num=args.cuda)
    encoder.load_model()

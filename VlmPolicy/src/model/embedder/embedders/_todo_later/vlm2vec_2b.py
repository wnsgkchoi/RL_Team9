    ...
    def __init__(
        ...
        if model_args is None:
            ...
            model_args = ModelArguments(
                model_name="/mnt/sdc/jhyun/models/Qwen2-VL-2B-Instruct",
                checkpoint_path="/mnt/sdc/jhyun/models/VLM2Vec-Qwen2VL-2B",
                pooling="last",
                normalize=True,
    ...
    def encode_queries(
        ...
        for i in iterator:
            ...
            try:
                ...
                emb_dim = getattr(self.model, "output_dim", 1536)
...
if __name__ == "__main__":
    ...
    inputs = processor(text=f'{vlm_image_tokens[QWEN2_VL]} Represent the given image with the following question: What is in the image',
                       images=Image.open('/root/omdr_workspace/catdog.webp'),
                       return_tensors="pt")

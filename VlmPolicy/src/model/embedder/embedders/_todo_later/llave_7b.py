...
# ───────────────────────────────────────────────────────────────────────────────
LLAVE_PATH                  = "/mnt/sdc/jhyun/models/LLaVE-7B"
...
# Main wrapper
# ───────────────────────────────────────────────────────────────────────────────
class LLaVE_7B(BaseEmbedder):
    """MMEmbed-compatible facade around the LLaVE-7B dual-encoder."""
    ...
    def load_model(self) -> None:
        ...
        self.model.eval()
        print("✅  LLaVE-7B loaded on", self.device)
...
if __name__ == "__main__":
    ...
    # 2) init + encode
    encoder = LLaVE_7B(cuda_num=args.cuda)
    encoder.load_model()

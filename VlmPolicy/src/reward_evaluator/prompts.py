...
def REWARD_EVALUATION_PROMPT(discount_factor: float = 0.9) -> str:
    """
...
- The outer "rewards" list length MUST equal "grid_size.rows".
- Each inner list length MUST equal "grid_size.cols".
